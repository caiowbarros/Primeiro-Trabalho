...
class Scene {
    constructor(shapeList) {
        ...
        this.VBO;
        this.IBO;
        this.shape = shapeList.selectedShape;
    }
    ...
    initBuffer() {
        ...
        gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(this.shape.verticesList), gl.STATIC_DRAW);
        ...
        gl.bufferData(gl.ELEMENT_ARRAY_BUFFER, new Uint16Array(this.shape.indices), gl.STATIC_DRAW);
    ...
    draw() {
        if (this.shape.type == PrimitiveType.POINT) {
            gl.bufferData(gl.ELEMENT_ARRAY_BUFFER, new Uint16Array(shape.indices.length), gl.STATIC_DRAW);
            gl.drawElements(gl.POINTS, shape.indices.length, gl.UNSIGNED_SHORT, 0);
        } else if (this.shape.type == PrimitiveType.RECTANGLE) {

        } else if (this.shape.type == PrimitiveType.POLYGON) {

        } else if (this.shape.type == PrimitiveType.CIRCLE) {
